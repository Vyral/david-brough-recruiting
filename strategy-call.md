...
<p>My name is David Brough with Anthony REALTORS and we sell hundreds of homes a year.</p>
...
<p>You’ll walk away with a plan of action, with steps you can take right away, to find homeowners who want to sell their home and list with you. </p>
...
<form method="post" class="home-value cta-forms" action="/thankyou" id="strategy-call-form">
					<fieldset>
						...
						<button class="g-recaptcha" data-sitekey="6Lemc_4ZAAAAAE_77KfVgkt05JZlUKogPQlasV6d" data-callback='onStrategyCallSubmit' data-badge="bottomleft">Submit</button></fieldset>
